...
const [numberCorrect, setNumberCorrect] = useState(false);
 ...
 return ( 
  <>
    ...
    <br /> 
    <br />
      Follow the link <a href="https://buy.stripe.com/7sI2bHdDmaKB2qI9AH">here</a> and once payment is confirmed I&#39;ll send you the code through secure email. Make sure to include your email on the form.
    </p>
    <br />
