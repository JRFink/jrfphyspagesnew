...
const Gravity = () => {
    return (
        <>
            ...
            <p> 
                Gravity is one of the four fundamental forces. We interact with it every day. In fact you can&#39;t choose not to interact with it. Studying it will give you a better unstanding of how common things in our world work, such as satellites, the moon, and how long before an apple hits the floor. 
            </p>
