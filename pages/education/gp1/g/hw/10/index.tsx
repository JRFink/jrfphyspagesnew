    ...
    return (
        <>
            ...
            <div className={style.flexContainer}>
                ...
                <br />
                <Link href="/education/gp1/g/hw/3#head" className={style.generalLink}>3</Link>
                <br />
                <Link href="/education/gp1/g/hw/4#head" className={style.generalLink}>4</Link>
                <br />
                <Link href="/education/gp1/g/hw/5#head" className={style.generalLink}>5</Link>
                <br />
                <Link href="/education/gp1/g/hw/6#head" className={style.generalLink}>6</Link>
                <br />
                ...
                <br />
                <Link href="/education/gp1/g/hw/10#head" className={style.yellowLink}>10</Link>
                <br />
                <Link href="/education/gp1/g/hw/11#head" className={style.generalLink}>11</Link>
                <br />
            </div>
            <h2>
                Extra credit - einstein and gravity
            </h2>
