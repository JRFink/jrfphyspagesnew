    ...
    return (
        <>
            ...
            <div className={style.flexContainer}>
                <Link href="/education/gp1/ideal/hw/1" className={style.generalLink}>1</Link>
                <br />
                <Link href="/education/gp1/ideal/hw/2" className={style.generalLink}>2</Link>
                <br />
                <Link href="/education/gp1/ideal/hw/3" className={style.yellowLink}>3</Link>
                <br />
