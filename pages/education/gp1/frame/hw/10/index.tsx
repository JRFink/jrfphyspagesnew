    ...
    return (
        <>
            ...
            <div className={style.flexContainer}>
                ...
                <br />
                <Link href="/education/gp1/frame/hw/10#head" className={style.yellowLink}>10</Link>
                <br />
                <Link href="/education/gp1/frame/hw/11#head" className={style.generalLink}>11</Link>
                <br />
            </div>
            <h2>
                Significant figures
