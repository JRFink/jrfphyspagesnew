    ...
    return (
        <>
            ...
            <div className={style.flexContainer}>
                <Link href="/education/gp1/wke/hw/1#head" className={style.generalLink}>1</Link>
                <br />
                <Link href="/education/gp1/wke/hw/2#head" className={style.generalLink}>2</Link>
                <br />
                <Link href="/education/gp1/wke/hw/3#head" className={style.generalLink}>3</Link>
                <br />
                ...
                <br />
                <Link href="/education/gp1/wke/hw/9#head" className={style.yellowLink}>9</Link>
                <br />
                <Link href="/education/gp1/wke/hw/10#head" className={style.generalLink}>10</Link>
                <br />
                <Link href="/education/gp1/wke/hw/11#head" className={style.generalLink}>11</Link>
                <br />
            </div>
            <h2>
                Work-energy in 3d - constant force
            </h2>
