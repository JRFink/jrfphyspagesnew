    ...
    return (
        <>
            ...
            <div className={style.flexContainer}>
                ...
                <br />
                <Link href="/education/gp1/taylor/hw/4#head" className={style.generalLink}>4</Link>
                <br />
                ...
                <br />
                <Link href="/education/gp1/taylor/hw/7#head" className={style.yellowLink}>7</Link>
                <br />
                <Link href="/education/gp1/taylor/hw/8#head" className={style.generalLink}>8</Link>
                <br />
                <Link href="/education/gp1/taylor/hw/9#head" className={style.generalLink}>9</Link>
                <br />
                <Link href="/education/gp1/taylor/hw/10#head" className={style.generalLink}>10</Link>
                <br />
                <Link href="/education/gp1/taylor/hw/11#head" className={style.generalLink}>11</Link>
                <br />
            </div>
            <h2>
