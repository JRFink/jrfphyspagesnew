    ...
    return (
        <>
            ...
            <div className={style.flexContainer}>
                <Link href="/education/gp1/osc/hw/1#head" className={style.generalLink}>1</Link>
                <br />
                ...
                <br />
                <Link href="/education/gp1/osc/hw/5#head" className={style.yellowLink}>5</Link>
                <br />
