    ...
    return (
        <>
            ...
            <h1 className={style.centerText}>
                ...
                <Link href="/education/gp1/fluid/hw/1" className={style.generalLink}>1</Link>
                <br />
                ...
                <br />
                <Link href="/education/gp1/fluid/hw/4" className={style.yellowLink}>4</Link>
                <br />
