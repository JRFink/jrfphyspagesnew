    ...
    return (
        <>
            ...
            <div className={style.flexContainer}>
                ...
                <br />
                <Link href="/education/cm1/angmom/hw/8#head" className={style.generalLink}>8</Link>
                <br />
                <Link href="/education/cm1/angmom/hw/9#head" className={style.generalLink}>9</Link>
                <br />
                <Link href="/education/cm1/angmom/hw/10#head" className={style.yellowLink}>10</Link>
                <br />
